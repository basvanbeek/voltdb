...
public class ExecuteTask extends VoltSystemProcedure {
    ...
    public DependencyPair executePlanFragment(
        ...
        if (fragmentId == SysProcFragmentId.PF_executeTask) {
            ...
            int taskId = (int)params.toArray()[0];
            byte[] payload = (byte [])params.toArray()[1];
    ...
    public VoltTable[] run(SystemProcedureExecutionContext ctx, int taskId, byte[] payload) {
        ...
        pfs[0].parameters = ParameterSet.fromArrayNoCopy(new Object[] {taskId, payload});
